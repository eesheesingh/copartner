        ...
        <div className="flex md:flex-row items-center flex-col justify-center gap-[1rem]">
          <div className={`flex-col text-center md:gap-[2rem] gap-0`}>
            <div className="flex flex-col justify-between items-center pb-[4rem]">
              <h1 className="font-inter font-[700] md:text-[72px] text-[44px] text-gradient">
                Privacy Policy
              </h1>
              ...
              <div className="flex flex-col">
                <h1
                  className="font-inter font-[700] md:text-[50px] text-[25px]
                    subheading-color leading-[51px] text-start"
                >
            ...
            <div className={`flex flex-col gap-2 md:pb-[4rem] md:w-[1190px]`}>
              <div className="flex flex-col">
                <h1
                  className="font-inter font-[700] md:text-[50px] text-[25px]
                   subheading-color leading-[70px] text-start"
                >
            ...
            <div className={`flex flex-col gap-2 md:pb-[4rem] md:w-[1190px]`}>
              <div className="flex flex-col">
                <h1
                  className="font-inter font-[700] md:text-[50px] text-[25px]
                    subheading-color leading-[51px] md:w-[935px] md:h-[60px] w-[365px] h-[40px] text-start"
                >
            ...
            <div className={`flex flex-col gap-2 md:pb-[4rem] md:w-[1190px]`}>
              <div className="flex flex-col">
                <h1
                  className="font-inter font-[700] md:text-[50px] text-[25px]
                    subheading-color leading-[51px] md:w-[1035px] md:h-[100px] w-[365px] h-[40px] text-start"
                >
            ...
            <div className={`flex flex-col gap-2 md:pb-[4rem] md:w-[1190px]`}>
              <div className="flex flex-col">
                <span
                  className="font-inter font-[700] md:text-[50px] text-[25px]
                    subheading-color leading-[51px] md:w-[735px] md:h-[60px] w-[365px] h-[40px] text-start"
                >
                  8. Grievance Officer
                </span>
