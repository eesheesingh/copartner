...
import { mission_vision, aboutUs_data, faq_data } from "../constants/data";
      ...
      <div className="flex flex-col md:gap-[2rem] gap-[1rem]">
        ...
        <div className="flex flex-col md:gap-[2rem] md:py-[2rem] md:mt-0 mt-[2rem] md:px-0 px-2">
          <div className="flex flex-col md:flex-start items-start flex-center">
            <span className="font-inter font-[700] md:text-[50px] text-[30px] subheading-color leading-[60px]">
              Mission & Vision
            </span>
        ...
        <div className="flex flex-col md:py-[4rem] md:px-0 px-4"> 
          <span className="md:w-[208px] h-[52px] font-inter font-[700] md:text-[50px] text-[30px] subheading-color leading-[51px] text-start">
            Features
          </span>
        ...
        <div className="flex flex-col md:items-center justify-center">
          <span className="md:w-[124px] h-[52px] font-inter font-[700] md:text-[50px] text-[30px] subheading-color leading-[51px] text-start md:px-0 px-4">
            FAQs
          </span>
