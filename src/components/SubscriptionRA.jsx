  ...
  return (
    ...
    <div key={expertData.id} className={`flex-1 ${styles.flexStart} flex-col xl:px-0 md:px-28 z-10 md:bottom-[10rem] font-inter`}>
      ...
      <section className="subscription-RA-bg flex flex-row justify-between bg-[#18181B80] relative w-full md:p-[30px] p-[16px] border-2 border-[#f4f4f50e] rounded-xl mb-8">
        ...
        text-gradient md:leading-[88px] leading-[30px] md:pb-3"
            ...
            <div className="flex mx-auto">
              <img
                ...
                src={ExpertImg}
                style={{maskImage:"linear-gradient(rgba(0, 0, 0, 1) 70%, transparent)"}}
                alt=""
              />
            </div>
          ...
          <div className="w-full flex flex-row bg-[#18181B80] rounded-2xl md:p-3 p-2">
            <div className="md:flex-col-6 md:text-[16px] text-[12px] flex flex-row my-3 md:mx-px mx-auto">
              ...
              <a href="#reviews">
              <button className="md:flex-col-3 md:mx-6 mx-2 md:text-[1rem] md:inline hidden text-[9.5px] text-[#A1A1AACC] hover:text-white" id>
                Reviews
              </button>
              </a>
            </div>
        ...
        <section className="md:flex md:flex-row md:justify-between text-center w-full md:mt-16 mt-10 md:mb-8 mb-3" id="subscribePlan">
...
<div className="text-white flex flex-wrap justify-center md:gap-8 w-full">
<div style={{backgroundColor}} className={`flex-1 rounded-2xl p-5 basic-div max-w-[400px] ${activeHoverIndex === 1 ? 'hover:bg-[#18181B80]' : ''}`} onMouseEnter={() => handleMouseEnter(1)} onMouseLeave={handleMouseLeave}>
        <div className="text-right opacity-60 hidden">
            21 Days Left
        </div>
        ...
        <div className="text-center">
            <button className="bg-white text-black md:px-12 px-6 md:text-base text-xs py-2 md:rounded-lg rounded border-4">
                Buy Now
            </button>
        </div>
    </div>
            ...
            <div
              className="flex-1 rounded-2xl p-5 basic-div hover:bg-[#18181B80]" onMouseOver={handleMouseOver}
            ...
            <div onMouseOver={handleMouseOver}
              onMouseOut={handleMouseOut} className={`flex-1 bg-opacity-5 p-5 hover:bg-[#18181B80] rounded-2xl standard-div ${activeHoverIndex === 3 ? 'hover:bg-[#18181B80]' : ''}`} onMouseEnter={() => handleMouseEnter(3)} onMouseLeave={handleMouseLeave}>
              ...
              <div className="text-center">
                <button className="text-white md:px-12 px-6 md:text-base text-xs py-2 md:rounded-lg rounded border-white border-2">
                  Buy Now
                     ...
                     <div onMouseOver={handleMouseOver}
              onMouseOut={handleMouseOut} className={`flex-1 bg-opacity-5 p-5 hover:bg-[#18181B80] rounded-2xl standard-div ${activeHoverIndex === 4 ? 'hover:bg-[#18181B80]' : ''}`} onMouseEnter={() => handleMouseEnter(4)} onMouseLeave={handleMouseLeave}>
              <div className="md:text-3xl text-lg font-bold subheading-gradient md:mb-4 mb-1 md:mt-1 mt-0">
                Standard
              </div>
              <div className="md:text-5xl text-2xl font-bold md:mb-3 mb-1 flex">
        ...
        <section className="w-full md:my-8 my-2 flex gap-20 md:mb-24 mb-16">
          <div className="flex flex-col md:w-2/3 w-full text-white"  id="keyHighlights">
          ...
          <div className="w-1/3 text-white md:block hidden">
            <div className="rounded-2xl flex flex-col gap-4 bg-[#18181B80] p-8 text-center">
              ...
              <div className="text-center">
                <button className="bg-white text-black px-12 py-2 rounded-lg  border-4">
                  Buy Now
                </button>
              </div>
            </div>
        ...
        <section className="border-2 rounded-2xl border-[#f4f4f50e] md:p-8 px-4 py-6 md:mb-24 mb-12"  id="subsDetails">
