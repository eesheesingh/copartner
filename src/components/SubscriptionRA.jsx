        ...
        <section className="w-full md:my-8 my-2 flex gap-20 md:mb-24 mb-16">
          ...
          <div className="w-1/3 text-white md:block hidden">
            <div className="rounded-2xl flex flex-col gap-4 bg-[#18181B80] p-8 text-center">
              ...
              <div style={{backgroundColor: backgroundColor2}} className="flex rounded-2xl p-4 border-2 border-[#F4F4F51A]">
              ...
              <div onMouseEnter={handleMouseOver2}
            onMouseLeave={handleMouseOut2} className="flex rounded-2xl p-4 hover:bg-[#18181B80] border-2 border-transparent hover:border-[#F4F4F51A]">
                <div className="flex-1 text-left">
            ...
            onMouseLeave={handleMouseOut2} className="flex rounded-2xl p-4 hover:bg-[#18181B80] border-2 border-transparent hover:border-[#F4F4F51A]">
              ...
              <div className="text-center">
                <button className="bg-white text-black px-12 py-2 rounded-lg  border-2">
                  Buy Now
                </button>
              </div>
            </div>
