...
const Hero = () => {
  ...
  return (
    <motion.div // Wrap the entire Hero component with motion.div
      ...
      className="hero-container md:h-[100vh] h-[50vh] flex justify-center items-center relative overflow-hidden" style={{ backgroundImage: `url(${CenterBg1})`, backgroundSize: '90%', backgroundRepeat:'no-repeat', backgroundPosition: 'center' }}
    >
