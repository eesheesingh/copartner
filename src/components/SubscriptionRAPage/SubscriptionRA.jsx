...
import { arrow, stars, tick, layer, RA1, rate, devices, videoImg, time, chart } from "../../assets";
  ...
  return (
    ...
    <div className="flex justify-center md:mb-4 mb-2 font-medium items-center text-left">
      ...
      <span className="md:text-base text-xs">
        ...
        <div key={index} className="text-white border border-solid border-white border-opacity-10 rounded-lg p-3 md:p-8 md:mb-16 mb-12 relative">
          {/* Rating */}
