  ...
  return (
    <div id="about-us" className="py-4 px-4" ref={aboutUsRef}> {/* Add ref to AboutUs section */}
      <div className="section3-heading text-center">
        ...
        <p className="text-90 md:text-xl text-[#c9c9c9] mb-6 md:px-[3rem] px-4">Our platform blends expert analysis, real-time insights, and seamless trader{" "} <br/>  collaboration,
