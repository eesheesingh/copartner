...
const Hero = () => {
  ...
  return (
    <motion.div // Wrap the entire Hero component with motion.div
      ...
      className="hero-container md:h-[100vh] h-[80vh] flex justify-center items-center relative overflow-hidden" style={{ backgroundImage: `url(${CenterBg1})`, backgroundSize: '90%', backgroundRepeat:'no-repeat', backgroundPosition: 'center' }}
    >
      <div className="hero-section md:max-w-[800px] md:w-[80%] md:h-[95vh] md:p-8 p-4 rounded-lg text-center flex flex-col justify-center relative">
        <h1 className="text-[2rem] md:text-[4.5rem] font-bold mb-4 text-gradient md:leading-[80px] leading-[40px] md:px-20 px-4">Invest, Learn and Earn</h1>
