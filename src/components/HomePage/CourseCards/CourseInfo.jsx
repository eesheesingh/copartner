...
import { chart, videoImg, time, calender, rate, devices, stars } from '../../../assets';
...
const CourseInfo = ({ courseData }) => {
  ...
  <div className="absolute top-0 right-0 z-10 flex items-center mt-2 mr-2">
    ...
    <p className="text-white text-sm font-semibold">4.4</p>
        ...
        <div className="md:w-1/2 w-full flex flex-col justify-center pl-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center">
              ...
              <p className="text-xs md:text-sm text-white ml-1">{courseData.level}</p>
            </div>
            <div className="flex items-center">
              <img src={time} alt="Time" className="w-4 h-4 mr-2" />
              <h4 className="md:text-base text-[12px] font-semibold text-[#e4e4e7a3]">Duration:</h4>
              <p className="text-xs md:text-sm text-white ml-1">{courseData.duration}</p>
            </div>
            <div className="flex items-center">
              ...
              <p className="text-xs md:text-sm text-white ml-1">{courseData.session}</p>
            </div>
            {/* <div className="flex items-center">
              <img src={videoImg} alt="Video" className="w-4 h-4 mr-2" />
            ...
            <div className="flex items-center">
              ...
              <p className="text-xs md:text-sm text-white ml-1">{courseData.access}</p>
            </div>
          ...
          <div className='py-3 flex md:flex-row items-center gap-5'>
            ...
            <button className='px-10 py-3 rounded-lg bg-[#fff] text-[#000] text-[15px] font-semibold'>Buy Now</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="sessionsDetails mt-8">
        <h4 className="text-4xl font-bold subheading-color md:block hidden">Sessions Details</h4>
      ...
      <div className="aboutCourse mt-8">
        <h4 className="text-4xl font-bold subheading-color md:block">About Course</h4>
